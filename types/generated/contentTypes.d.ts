...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    card: Attribute.DynamicZone<['card.card']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bio: Attribute.Text;
    photo_stories: Attribute.Relation<
      'api::author.author',
      'manyToMany',
      'api::photo-story.photo-story'
    >;
    links: Attribute.Component<'social.social-links', true>;
    video_stories: Attribute.Relation<
      'api::author.author',
      'manyToMany',
      'api::video-story.video-story'
    >;
...
export interface ApiPhotoStoryPhotoStory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.JSON &
      ...
      Attribute.CustomField<
        ...
        ['Latest', 'Technology', 'Business', 'Entertainment']
      >;
    story_content: Attribute.Blocks;
    sub_headline: Attribute.Text;
    slug: Attribute.UID<'api::photo-story.photo-story', 'headline'> &
      Attribute.Required;
...
export interface ApiStoryStory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    story_type: Attribute.DynamicZone<
      [
...
export interface ApiVideoStoryVideoStory extends Schema.CollectionType {
  ...
  attributes: {
    headline: Attribute.String & Attribute.Required;
    sub_headline: Attribute.Text;
    video: Attribute.DynamicZone<['video-story.video-story']>;
    category: Attribute.Enumeration<
      ['Latest', 'Technology', 'Business', 'Entertainment']
    >;
    authors: Attribute.Relation<
...
export interface ApiWebStoryWebStory extends Schema.CollectionType {
  ...
  attributes: {
    headline: Attribute.String;
    sub_headline: Attribute.Text;
    slug: Attribute.UID<'api::web-story.web-story', 'headline'>;
    hero_image: Attribute.Media;
    category: Attribute.Enumeration<
      ['Latest', 'Technology', 'Business', 'Entertainment ']
    > &
    ...
    authors: Attribute.Relation<
      ...
      'api::author.author'
    >;
    Pages: Attribute.Component<'web-story.web-story', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::photo-story.photo-story': ApiPhotoStoryPhotoStory;
      'api::story.story': ApiStoryStory;
      'api::video-story.video-story': ApiVideoStoryVideoStory;
